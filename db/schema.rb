...
ActiveRecord::Schema.define(version: 2023_04_04_065605) do
  ...
  create_table "car_insurance_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "car_number"
    t.string "name"
    t.string "email"
    t.string "phone"
  ...
  create_table "life_insurance_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "age"
    t.string "phone"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "sms", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
